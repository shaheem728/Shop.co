    ...
    <nav className="flex mb-20  flex-col fixed w-full z-10 justify-between bg-white border-b-2">
      ...
      <div className="max-w-screen-xl flex flex-wrap lg:gap-5 justify-between  p-4">
        ...
        <div
          className={`${
            isOpen == true ? `` : "hidden"
          } lg:hidden fixed top-0 left-0 rounded-sm z-10 w-[100%] p-4   bg-gray-100`}
        >
          <button
            type="button"
          ...
          <div className="flex flex-col justify-center items-center ">
            <SearchBox />
            <ul className="flex flex-col font-medium p-5  border border-gray-100 rounded-lg bg-gray-50 md:space-x-8  md:flex-row md:mt-0 md:border-0 ">
              {nav.map((nav, index) => {
                return (
                  <li key={index}>
            ...
            >
              ...
              {user == true && (
                <>
                  ...
                  >
                  <span className="header-dropdown"> Logout</span> 
                  </li>
                </>
              )}
               {isAdmin == "true" && (
                    <>
                      ...
                      >
                        <span className="header-dropdown">Admin</span>
                      </li>
                    </>
                  )}
